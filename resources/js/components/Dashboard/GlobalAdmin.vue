        ...
        <div class="scroll-sidebar">
          ...
          <nav class="sidebar-nav">
            <ul id="sidebarnav" class="pt-4">
                ...
                <router-link class="sidebar-link waves-effect waves-dark sidebar-link" :to="'/adminpanel'">
                <i class="fas fa-home"></i>
                <span class="hide-menu">Home</span>
                </router-link>
              </li>
              <li class="sidebar-item">
                <router-link class="sidebar-link waves-effect waves-dark sidebar-link" :to="'/adminpanel/users'">
                <i class="fas fa-user"></i>
                <span class="hide-menu">Users</span>
                </router-link>
              </li>
              <li class="sidebar-item">
                <router-link class="sidebar-link waves-effect waves-dark sidebar-link" :to="'/adminpanel/posts'">
                <i class="fas fa-sticky-note"></i>
                <span class="hide-menu">Posts</span>
                </router-link>
              </li>
              <li class="sidebar-item">
                <router-link class="sidebar-link waves-effect waves-dark sidebar-link" :to="'/adminpanel/categories'">
                <i class="fa fa-list-alt"></i>
                <span class="hide-menu">Categories</span>
                </router-link>
              </li>
              <li class="sidebar-item">
                <router-link class="sidebar-link waves-effect waves-dark sidebar-link" :to="'/adminpanel/comments'">
                <i class="fa fa-comment"></i>
                <span class="hide-menu">Comments</span>
                </router-link>
              </li>
                <li class="sidebar-item">
                <router-link class="sidebar-link waves-effect waves-dark sidebar-link" :to="'/adminpanel/settings'">
                <i class="fa fa-cog"></i>
